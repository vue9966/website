...
/**
 * 开始
 * @param {Element} el canvas
 * @param {Element} parent 最外层节点，布局用
 */
export function start(el, parent) {
    stop = false;
    /** canvas容器 */
    const canvas = el;
    /** 圆 */
    ...
    function createBubble() {
        ...
        function move() {
            ...
            // 透明度
            if (node.opacity < 0.6) {
                node.opacity += 0.001 * node.speed.vertical;
